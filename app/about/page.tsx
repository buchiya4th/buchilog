...
const state = {
  ...
  biography: {
    ...
    body: [
      ...
      { th: '2008年', td: '音楽活動が煮え切らず上京。新境地にて音楽修行を始めた。' },
      { th: '2013年', td: '人生を見つめ直し生活基盤を安定させるため『音楽 < 仕事』に比重を改め小規模なWeb制作会社へ転職した。' },
      { th: '2014年', td: 'マークアップエンジニアとWebディレクターを兼務し制作チームリーダーとして各案件を滞りなく完遂できるよう推進していった。' },
      { th: '2015年', td: 'Webフロントエンド領域をより深めていくべく、大企業へ転職してフロントエンドエンジニアとして従事した。' },
      { th: '2016年', td: 'Webフロントエンドエンジニアチームのマネージャに就き、各自が自走できる体制を整え業務が円滑になるよう努めた。' },
      { th: '2018年', td: '家族が増え生活スタイルが激変した。' },
      { th: '2020年', td: 'グローバル企業へ転職、そしてコロナ禍で生活スタイルが激変した。' },
      { th: '2022年', td: '仕事の方向性を見つめ直しベンチャー企業へ転職した。' },
    ]
  }
}
